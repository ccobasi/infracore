        ...
        <div class="centered">
          ...
          <form action="">
            <div class="first d-flex">
              ...
              <div class="mb-3">
                <label for="exampleFormControlTextarea1" class="form-label">Industry/Sector</label>
            ...
            <div class="first d-flex">
              <div class="mb-3">
                <label for="exampleFormControlInput1" class="form-label">Primary Contact Email</label>
                <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Type here">
              </div>
              <div class="mb-3">
                <label for="exampleFormControlTextarea1" class="form-label">Primary Contact Phone No.</label>
                <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Type here">
              </div>
            </div>
            <div class="first d-flex">
              <div class="mb-3">
                <label for="exampleFormControlInput1" class="form-label">Secondary Contact Email</label>
                <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Type here">
              </div>
              <div class="mb-3">
                <label for="exampleFormControlTextarea1" class="form-label">Secondary Contact Phone No.</label>
                <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Type here">
              </div>
            </div>
            <div class="second">
              <div class="mb-3">
                <label for="exampleFormControlInput1" class="form-label">What does your company do?</label>
                <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Type here">
              </div>
            </div>
            <div class="second">
              <div class="mb-3">
                <label for="exampleFormControlInput1" class="form-label">What do you need InfraCredit Facilities for?</label>
                <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Type here">
              </div>
            </div>
            <div class="third">
            ...
            <div class="note">
              <span class="by">By creating an account means you agree to the </span><span class="terms">Terms & Conditions and our Privacy Policy</span>
            </div>
            ...
            <div class="account">
              <label for="">Already have an account</label><button>Login</button>
            </div>
            <div class="support">
